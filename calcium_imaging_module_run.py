...
import calcium_imaging_analysis_assemblies_synch as test
#%%
test = analyze_ca(file_directory= "//ucdenver.pvt/som/NEUROSURG/N_ LAB - Alexander/Data/calcium imaging/calcium imaging sample movie",
